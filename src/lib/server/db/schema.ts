...
export const users = pgTable('users', {
	...
	osPlatformVersion: text('os_platform_version'),
	browserFullVersion: text('browser_full_version'),
	dpr: real('dpr'),
	...
	pointerCoarse: boolean('pointer_coarse'),
	hoverNone: boolean('hover_none'),
	cpuCores: integer('cpu_cores'),
	deviceMemory: real('device_memory'),
	connectionType: text('connection_type'),
	connectionEffectiveType: text('connection_effective_type'),
	connectionDownlink: real('connection_downlink'),
