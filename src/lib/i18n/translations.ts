...
export const translations: Record<Locale, Record<string, string>> = {
	'en-US': {
		...
		'about.hereIsInfo':
			'Here is all the information we gathered based on your visits and preferences to help deliver a tailored experience.',
		'about.consentNote':
			'Note: You have not provided analytics consent, so your exact environment and network data (like location and detailed browser stats) are not stored on our servers.',
		'about.functionalPreferences': 'Functional Preferences',
		'about.darkMode': 'Dark Mode',
		'about.locale': 'Locale',
		'about.timezone': 'Timezone',
		'about.reducedMotion': 'Reduced Motion',
		'about.highContrast': 'High Contrast',
		'about.sound': 'Sound',
		'about.engagementStats': 'Engagement Stats',
		'about.firstVisit': 'First Visit',
		'about.totalVisits': 'Total Visits',
		'about.currentStreak': 'Current Streak',
		'about.longestStreak': 'Longest Streak',
		'about.onboardingCompleted': 'Onboarding Completed',
		'about.browserEnvironment': 'Browser & Environment',
		'about.browser': 'Browser',
		'about.os': 'OS',
		'about.device': 'Device',
		'about.screenSize': 'Screen Size',
		'about.pixelRatio': 'Pixel Ratio (DPR)',
		'about.location': 'Location',
		'about.country': 'Country',
		'about.region': 'Region',
		'about.city': 'City',
		'about.ipAddress': 'IP Address',
		'about.map': 'Map',
	...
	'nl-NL': {
		...
		// About You
		'about.aboutYou': 'Over Jou',
		'about.hereIsInfo':
			'Hier is alle informatie die wij verzameld hebben op basis van je bezoeken en voorkeuren, om een zo goed mogelijke ervaring te bieden.',
		'about.consentNote':
			'Let op: Je hebt geen toestemming voor analyses gegeven, dus we slaan je netwerk- en omgevingsdata (zoals je locatie en browser statistieken) niet op onze servers op.',
		'about.functionalPreferences': 'Functionele Voorkeuren',
		'about.darkMode': 'Donkere Modus',
		'about.locale': 'Lokalisatie',
		'about.timezone': 'Tijdzone',
		'about.reducedMotion': 'Verminderde Beweging',
		'about.highContrast': 'Hoog Contrast',
		'about.sound': 'Geluid',
		'about.engagementStats': 'Betrokkenheid Statistieken',
		'about.firstVisit': 'Eerste Bezoek',
		'about.totalVisits': 'Totaal Aantal Bezoeken',
		'about.currentStreak': 'Huidige Reeks',
		'about.longestStreak': 'Langste Reeks',
		'about.onboardingCompleted': 'Introductie Voltooid',
		'about.browserEnvironment': 'Browser & Omgeving',
		'about.browser': 'Browser',
		'about.os': 'Besturingssysteem',
		'about.device': 'Apparaat',
		'about.screenSize': 'Schermgrootte',
		'about.pixelRatio': 'Pixelverhouding (DPR)',
		'about.location': 'Locatie',
		'about.country': 'Land',
		'about.region': 'Regio',
		'about.city': 'Stad',
		'about.ipAddress': 'IP Adres',
		'about.map': 'Kaart',
		'about.enabled': 'Ingeschakeld',
		'about.disabled': 'Uitgeschakeld',
		'about.unknown': 'Onbekend',
		'about.yes': 'Ja',
		'about.no': 'Nee',
		'about.hidden': 'Verborgen',
		'about.days': 'dagen',
		'about.desktop': 'Desktop',
		'about.auto': 'Auto',
