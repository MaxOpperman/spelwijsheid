...
export const translations: Record<Locale, Record<string, string>> = {
	'en-US': {
		...
		'about.map': 'Map',
		'about.isp': 'Internet Service Provider',
		'about.asn': 'Autonomous System Number',
		'about.continent': 'Continent',
		'about.euMember': 'EU Member',
		'about.regionCode': 'Region Code',
		'about.postalCode': 'Postal Code',
		'about.accuracyRadius': 'Location Accuracy',
		'about.geoTimezone': 'Timezone (GeoIP)',
		'about.registeredCountry': 'Registered Country (ISP)',
		'about.subregion': 'Sub-region',
		'about.cpuArch': 'CPU Architecture',
		'about.osPlatformVersion': 'OS Platform Version',
		'about.browserFullVersion': 'Browser Full Version',
		'about.colorDepth': 'Colour Depth',
		'about.pointerCoarse': 'Touch Input',
		'about.hoverNone': 'Hover Capable',
		'about.cpuCores': 'CPU Cores',
		'about.deviceMemory': 'Device Memory',
		'about.connectionType': 'Connection Type',
		'about.connectionEffectiveType': 'Effective Connection',
		'about.connectionDownlink': 'Downlink Speed',
		...
		// About You — advanced section
		'about.advanced': 'Advanced',
		'about.advancedDesc': 'Technical and internal data linked to your session.',
		'about.account': 'Account',
		'about.userId': 'User ID',
		'about.lastSeen': 'Last Seen',
		'about.lastActiveAt': 'Last Active',
		'about.lastStreakDate': 'Last Streak Date',
		'about.referrer': 'Referrer',
		'about.consent': 'Consent',
		'about.consentFunctional': 'Functional Consent',
		'about.consentUpdatedAt': 'Consent Updated',
		'about.consentVersion': 'Consent Version',
		'about.dataLifecycle': 'Data Lifecycle',
		'about.deletedAt': 'Deletion Date',
		'about.dataRetentionExpiresAt': 'Data Retention Expires',
		'about.networkEnvironment': 'Network & Environment',
		'about.languageHeader': 'Accept-Language Header',
		'about.colorScheme': 'Color Scheme',
		'about.viewportSize': 'Viewport Size',
		'about.identityMatching': 'Identity Matching',
		'about.identityId': 'Identity ID',
		'about.fingerprintHash': 'Fingerprint Hash',
		'about.matchConfidence': 'Match Confidence',
		'about.matchedUserIds': 'Matched User IDs',
		'about.nearbyDevices': 'Detected Nearby',
		'about.nearbyDevicesDesc':
			'Other sessions on the same IP within the past 30 days. These could be family members, colleagues, or other devices you use.',
		'about.nearbyDevicesNone': 'No other sessions detected on your network.',
		'about.today': 'today',
	...
	'nl-NL': {
		...
		'about.isp': 'Internetprovider',
		'about.asn': 'Autonoom Systeemnummer',
		'about.continent': 'Continent',
		'about.euMember': 'EU-lid',
		'about.regionCode': 'Regiocode',
		'about.postalCode': 'Postcode',
		'about.accuracyRadius': 'Locatienauwkeurigheid',
		'about.geoTimezone': 'Tijdzone (GeoIP)',
		'about.registeredCountry': 'Geregistreerd Land (ISP)',
		'about.subregion': 'Subregio',
		'about.cpuArch': 'CPU-architectuur',
		'about.osPlatformVersion': 'Platformversie OS',
		'about.browserFullVersion': 'Volledige Browserversie',
		'about.colorDepth': 'Kleurdiepte',
		'about.pointerCoarse': 'Aanraakinvoer',
		'about.hoverNone': 'Hover Mogelijk',
		'about.cpuCores': 'CPU-kernen',
		'about.deviceMemory': 'Apparaatgeheugen',
		'about.connectionType': 'Verbindingstype',
		'about.connectionEffectiveType': 'Effectieve Verbinding',
		'about.connectionDownlink': 'Downloadsnelheid',
		'about.map': 'Kaart',
		...
		// About You — advanced section
		'about.advanced': 'Geavanceerd',
		'about.advancedDesc': 'Technische en interne data gekoppeld aan jouw sessie.',
		'about.account': 'Account',
		'about.userId': 'Gebruikers ID',
		'about.lastSeen': 'Laatst Gezien',
		'about.lastActiveAt': 'Laatst Actief',
		'about.lastStreakDate': 'Laatste Reeksdatum',
		'about.referrer': 'Verwijzer',
		'about.consent': 'Toestemming',
		'about.consentFunctional': 'Functionele Toestemming',
		'about.consentUpdatedAt': 'Toestemming Bijgewerkt',
		'about.consentVersion': 'Toestemming Versie',
		'about.dataLifecycle': 'Gegevensbeheer',
		'about.deletedAt': 'Verwijderdatum',
		'about.dataRetentionExpiresAt': 'Gegevens Vervallen Op',
		'about.networkEnvironment': 'Netwerk & Omgeving',
		'about.languageHeader': 'Accept-Language Header',
		'about.colorScheme': 'Kleurenschema',
		'about.viewportSize': 'Viewportgrootte',
		'about.identityMatching': 'Identiteitsherkenning',
		'about.identityId': 'Identiteits ID',
		'about.fingerprintHash': 'Vingerafdruk Hash',
		'about.matchConfidence': 'Herkenningzekerheid',
		'about.matchedUserIds': "Gekoppelde Gebruikers ID's",
		'about.nearbyDevices': 'Nabijgelegen Sessies',
		'about.nearbyDevicesDesc':
			"Andere sessies op hetzelfde netwerk in de afgelopen 30 dagen. Dit kunnen familieleden, collega's of andere apparaten van jou zijn.",
		'about.nearbyDevicesNone': 'Geen andere sessies gevonden op jouw netwerk.',
		'about.nearbyDevicesSameIp': 'Zelfde netwerk',
		'about.today': 'vandaag',
		'about.yesterday': 'gisteren',
		'about.daysAgo': 'dagen geleden',
		'about.never': 'Nooit',
